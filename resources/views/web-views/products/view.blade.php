                ...
                <div class="cz-sidebar rounded-lg box-shadow-lg" id="shop-sidebar" style="margin-bottom: -10px;">
                    ...
                    <div class="cz-sidebar-body pb-0" style="padding-top: 12px;">
                        ...
                        <div
                                ...
                                style="width: 100%">
                                <form class="" id="search-form2" action="{{ route('products') }}" method="GET">
                                <input hidden name="data_from" value="{{$data['data_from']}}">
                                <div class="form-inline flex-nowrap mr-3 mr-sm-4 pb-3 for-mobile">
                                   
                                    <select style="background: whitesmoke; appearance: auto;"
                                            class="form-control custom-select" onchange="city(this.value)">
                                            <option value="{{null}}"></option>
                                            <option disabled> -- Makkah Province --</option>
                                            <option>Jeddah </option>
                                            <option>City of Makkah</option>
                                            <option>Ta'if </option>
                                            <option>Qunfudhah </option>
                                            <option>Laith </option>
                                            <option>Jumum </option>
                                            <option>Rabigh </option>
                                            <option>Khulays </option>
                                            <option>Ranyah </option>
                                            <option>Turbah </option>
                                            <option>Khurmah </option>
                                            <option>Kamil </option>
                                            
                                            <option disabled> -- Riyadh Province --</option>
                                            <option>City of Riyadh</option>
                                            <option>Kharj </option>
                                            <option>Duwaidmi </option>
                                            <option>Majma'ah </option>
                                            <option>Quwai'iyah </option>
                                            <option>Wadi ad-Dawasir </option>
                                            <option>'Afif </option>
                                            <option>Zulfi </option>
                                            <option>Dir'iyah </option>
                                            <option>Aflaj </option>
                                            <option>Hawtat Bani Tamim </option>
                                            <option>Muzahmiyah </option>
                                            <option>Sulayyil </option>
                                            <option>Shaqra' </option>
                                            <option>Rumah </option>
                                            <option>Dhurma </option>
                                            <option>Thadij </option>
                                            <option>Hariq </option>
